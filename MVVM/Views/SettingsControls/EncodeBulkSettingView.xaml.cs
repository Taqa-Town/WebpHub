...
public sealed partial class EncodeBulkSettingView : UserControl
{
    public EncodeOptionsBuilderService OptionsBuilder { get; private set; }
    private readonly DispatcherTimer timer;

    public EncodeBulkSettingView()
    {
        InitializeComponent();
        OptionsBuilder = new EncodeOptionsBuilderService();
        timer = new();
    }
    ...
    private void SaveBtn_Click(object sender, RoutedEventArgs e)
    {
        ...
        EncodeBulkView.WebpManager.Options = OptionsBuilder.ConstructOptions();
