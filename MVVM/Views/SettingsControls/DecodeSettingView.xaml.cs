...
public sealed partial class DecodeSettingView : UserControl
{
    public DecodeOptionsBuilderService OptionsBuilder { get; private set; }
    private readonly DispatcherTimer timer;

    public DecodeSettingView()
    {
        InitializeComponent();
        timer = new();
        OptionsBuilder = new();
    ...
    private void SaveBtn_Click(object sender, RoutedEventArgs e)
    {
        ...
        DecodeView.WebpManager.Options = OptionsBuilder.ConstructOptions();
